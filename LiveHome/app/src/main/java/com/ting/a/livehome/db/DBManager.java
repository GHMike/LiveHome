 ...
 * SQLite数据库管理类
 * 
 * 主要负责数据库资源的初始化,开启,关闭,以及获得DBHelper帮助类操作
 * 
 */
public class DBManager {
	private String databaseName = "myDB.db";
	private int version = 1;//测试1
	...
	/**
	 * 打开数据库,SQLiteDatabase一旦被关闭,会重新产生一个新的SQLiteDatabase
	 */
	...
	public DBHelper getDatabaseHelper() {
		return new DBHelper(mContext, this.databaseName, null,
				this.version);
	}
